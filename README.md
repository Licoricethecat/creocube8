...
Also. Both Xaero's and Journeymap are included within the modpack, disable whichever minimap mod you don't want. (Note: openpac claiming is easier with xaero's, so if you want to play with journeymap leave xaero's enablesd but you can disable its minimap)
...
<br>
Also, for anyone who despises BetterCombat, here's a fully client-side toggle mod to disable it (packaged in every modpack version after 1.0.0):
