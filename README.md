...
you also do not need to redownload each new pack if you don't want, each release will include the base mod/config files and all you need to do is add those files to your instance or remove any mods mentioned in the changelog.
